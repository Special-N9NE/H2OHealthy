...
public class FragmentSplashBindingImpl extends FragmentSplashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvTitle1, 1);
        sViewsWithIds.put(R.id.tvTitle2, 2);
        sViewsWithIds.put(R.id.bStart, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((org.n9ne.auth.viewModel.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable org.n9ne.auth.viewModel.SplashViewModel ViewModel) {
